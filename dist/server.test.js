...
describe("GET /digipet/hatch", () => {
    ...
    test("if the user has no digipet, it responds with a message about successfully hatching a digipet and calls hatchDigipet", () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        model_1.setDigipet(undefined);
        // act
        console.log('before', model_1.getDigipet());
        const response = yield supertest_1.default(server_1.default).get("/digipet/hatch");
        console.log('after', response.body);
        // assert
...
describe("GET /digipet/train", () => {
    test("if the user has a digipet, it calls the trainDigipet controller and responds with a message about training the digipet", () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        console.log('after', model_1.getDigipet());
...
describe.only("GET /digipet/ignore", () => {
    test("if the user has a digipet, it calls the trainDigipet controller and responds with a message about ignoring the digipet", () => __awaiter(void 0, void 0, void 0, function* () {
        // setup
        model_1.setDigipet(model_1.INITIAL_DIGIPET);
...
describe("GET /digipet/rehome", () => {
    test("if the user has a digipet, it calls the rehomeDigipet controller and responds with a message about rehoming the digipet", () => __awaiter(void 0, void 0, void 0, function* () {
        // setup: reset digipet
        model_1.setDigipet(model_1.INITIAL_DIGIPET);
        ...
        // response includes digipet data
        expect(response.body.digipet).toEqual(undefined);
    }));
});
